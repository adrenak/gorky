 ...
 */
function generatePostsMd(postsPath, postsMdPath, contentDir = 'content') {
    ...
    posts.forEach(post => {
        ...
        if (post.thumbnail) {
            ...
            postsBody += `## [${post.title}](?post=${post.slug})\n\n`;
            if (post.description) {
